 ...
 * enable serving of assets from arbitrary file-system path in production!
 * the external filesystem handling was "back-ported" from ninjaframework
 * the feature was removed due to security considerations
 * --> see: https://github.com/ninjaframework/ninja/commit/81d29be2a16f0c261d12d2363db7144dd512634b
 * @author henrik
 */
